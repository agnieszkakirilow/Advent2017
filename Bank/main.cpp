...
int main()
{
    ...
    std::array<int, bankNumber> compareArray {};
    int loopCount = 0;
...
//        }
        ...
        for (int i = 0; i <= loopCount; i++)
        {
            ...
            {
                found = 1;
                std::cout << "loopCountFor=" << loopCount << std::endl;
                compareArray = changeableArray;
                break;
            }
...
//        }
    ...
    std::cout << "loopCountBla=" << loopCount;
    bool secFound = 0;
    unsigned int secLoop = loopCount;
    while ( !secFound )
    {
        int max = originalArray[0];
        for (auto x : originalArray)
...
//        }
        std::cout << std::endl;
        if (changeableArray == compareArray)
        {
            secFound = 1;
            break;
        }
        originalArray = changeableArray;
        secLoop++;
        Matrix[secLoop] = changeableArray;
//        for (int i = 0; i <= loopCount; i++)
//        {
//            for (int j = 0; j < bankNumber; j++)
//            {
...
//            std::cout << std::endl;
//        }
        std::cout << "secLoop1=" << secLoop << std::endl;
    }
    std::cout << "loopCountBla2=" << loopCount;
    std::cout << "secLoop2=" << secLoop;
    return 0;
}
